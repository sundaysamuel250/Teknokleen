...
const OurClientSection = () => {
  ...
  return (
    <>
      <div className="flex items-center justify-center border-2 border-[#85CFF280]  lg:w-full lg:h-[212px] md:w-[100%] md:h-[212px] h-[150px] lg:rounded-l-[400px] md:rounded-l-[400px] rounded-l-[200px] border-bl-4 lg:mt-6 md:mt-6  lg:ml-[8rem]">
