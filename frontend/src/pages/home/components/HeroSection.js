    ...
    > 
      <section className="md:mt-40 mt-40">
       ...
       <section className="px-[1rem] lg:p-0  md:-p-0"> 
        ...
        <b>
          Corperate Cleaning...</b></motion.h1>
        <motion.p 
        initial={{x: -999}}
        animate={{x: -10}}
        transition={{ 
        ...
        className="md:w-[513px] italic md:text-[16px] text-[10px] font-['Poppins'] lg:leading-[30px] md:leading-[30px] leading-[16px] text-[#4F4F4F] ">
          We provide comprehensive solutions for corporate cleaning, including sales and distribution 
            of equipment, products, and expert training and consultancy services.</motion.p>
       </section>
       </section>
