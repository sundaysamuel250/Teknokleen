  ...
  return (
    ...
    > 
      <section className="md:mt-40 mt-40">
        ...
        text-[#23146D] text-[12px] mb-10 font-gochi-hand font-normal ">trusted cleaning services</p>
       <section className="">
       <section className="px-[1rem] lg:p-0  md:-p-0"> 
        ...
        <b>
        Partners in Holistic Hygiene</b></motion.h1>
        <motion.p 
        initial={{x: -999}}
        animate={{x: -10}}
        transition={{ 
        ...
        className="md:w-[513px] italic md:text-[16px] text-[10px] font-['Poppins'] lg:leading-[30px] md:leading-[30px] leading-[16px] text-[#4F4F4F] ">
          Elevate Hygiene Standards with Our Comprehensive Cleaning Solutions</motion.p>
       </section>
       </section>
       <section className="md:flex py-12 gap-5 flex"> 
        <button className="bg-[#23146D] hover:bg-[#00A5E2] hover:tracking-[1px] md:w-[203px] md:h-[64px] w-[150px] h-[40px] rounded-[10px] text-[#fff] font-normal font-['Poppins'] md:text-[16px] text-[10px] leeding-none not-italic border-none tracking-wide ">Book Now</button>
        <button className="bg-[#fff] hover:bg-[#FAECC9] hover:tracking-[1px] md:w-[203px] md:h-[64px] w-[150px] h-[40px] rounded-[10px] text-[#23146D] font-normal font-['Poppins'] md:text-[16px] text-[10px] leeding-none not-italic border-[#23146D] border-[2px] tracking-wide">Learn More</button>
      ...
      <section>
        ...
        <section className="md:relative absolute right-10 md:right-[-8rem] lg:right-[-9rem] padding-[4rem]">
          <motion.div 
          ...
          <div className="">
        <svg xmlns="http://www.w3.org/2000/svg" className="md:w-[554px] md:h-[746px] w-[200px] h-[200px]" viewBox="0 0 554 746" fill="none">
         <path d="M267.18 718.451C-191.464 576.118 42.7271 181.213 217.153 1.55255L436.77 -63.3346L779.453 -112L868 177.376C858.828 417.04 725.824 860.784 267.18 718.451Z" fill="#FAECC9" fill-opacity="0.6"/>
       </svg>
       </div>
        </section>
      </section>
